...
//     NoffHeader* noffH=new NoffHeader;
//     unsigned int size;
...
//         return FALSE;
//     }
//     DEBUG(dbgSys, "LOAD FUNC:"<<executable<< "\n");
...
//     DEBUG(dbgSys, "NUM PAGES: "<<numPages);
//     DEBUG(dbgSys, "FREE PAGES: "<<getNumFreePages());
//     noffH->initData.size = (int)size;
